...
public final class IKTokenizer extends Tokenizer {
	...
	public IKTokenizer(boolean useSmart, String dicFiles) {
		super();
		init(useSmart, dicFiles);
	}

	public IKTokenizer(boolean useSmart, String dicFiles, String distributedDicPath) {
		super();
	...
	public IKTokenizer(AttributeFactory factory, boolean useSmart, String dicFiles) {
		super(factory);
		init(useSmart, dicFiles);
	}
	...
	private void init(boolean useSmart, String dicFiles) {
		if (null == dicFiles)
			init(useSmart);
		else {
			addAttributes();
			_IKImplement = new IKSegmenter(input, useSmart, dicFiles);
		}
	}
